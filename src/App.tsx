...
const SERVICES = [
  ...
  },
  {
    ...
    icon: Cloud,
    overview:
      "Seamless migration and management of Azure, AWS, and private cloud environments.",
  ...
  },
  {
    ...
    icon: Code2,
    overview:
      "Bespoke software solutions tailored to your specific business workflows and challenges.",
    target:
      "Enterprises needing custom tools that off-the-shelf software can't provide.",
  ...
  },
  {
    ...
    icon: BarChart3,
    overview:
      "Strategic technology roadmaps aligned with your long-term business objectives.",
...
const Footer = ({ setPage }: { setPage: (p: Page) => void }) => (
  <footer className="bg-slate-50 text-slate-600 py-16 px-6 border-t border-slate-200">
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
      <div className="col-span-1 md:col-span-2">
        ...
        <p className="max-w-md mb-8 leading-relaxed">
          ...
          cyber security, and strategic managed services. Your partner in
          digital excellence.
        </p>
        <div className="flex gap-4">
          <a
            href="#"
            className="p-2 bg-slate-200 rounded-full hover:bg-slate-300 text-slate-700 transition-colors"
          >
            <Linkedin size={20} />
          </a>
          <a
    ...
    <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-slate-200 grid grid-cols-1 md:grid-cols-2 gap-8 text-xs text-slate-600">
      <div className="space-y-2">
        <p className="text-slate-500 uppercase tracking-widest font-bold mb-2">
          Company Details
        </p>
  ...
  <div className="pt-20">
      ...
      <div className="section-padding grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-xl">
            ...
            and managed services tailored for the unique challenges of the UK
            market.
          </p>
    ...
    <section className="section-padding">
      <div className="text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Why Choose Sunburst House?
        </h2>
        <p className="text-slate-600 max-w-2xl mx-auto">
          We combine technical excellence with a deep understanding of the UK
          business landscape.
        </p>
      </div>
        ...
        {[
          {
            ...
            desc: "Our London-based helpdesk is available around the clock to keep your business running.",
          },
          {
            icon: Shield,
            title: "GDPR Compliant",
            desc: "We ensure all your data handling and IT systems meet strict UK and EU regulations.",
          },
          {
            icon: BarChart3,
            title: "ROI Driven",
            desc: "We don't just fix computers; we implement technology that drives your bottom line.",
          },
        ].map((benefit, i) => (
          <div
            key={i}
            className="p-8 rounded-2xl border border-slate-100 bg-slate-50 hover:border-brand-accent transition-all group"
          >
      ...
      <div className="section-padding grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          <h2 className="text-3xl md:text-4xl font-bold mb-8">
            Measurable Results for UK Leaders
          </h2>
          <div className="space-y-8">
            <div className="border-l-4 border-brand-accent pl-6">
              <p className="text-brand-accent font-bold uppercase tracking-widest text-sm mb-2">
                Case Study: FinTech London
              </p>
        ...
        {[
          {
            ...
            quote:
              "Sunburst House transformed our IT from a headache into a strategic asset. Their response times are unmatched in London.",
          },
          {
            name: "Sarah Miller",
            role: "Operations Director, Miller & Co",
            quote:
              "The cyber security audit they performed was eye-opening. We now feel completely secure and compliant with GDPR.",
          },
        ].map((t, i) => (
          <div
            key={i}
            className="p-8 rounded-2xl border border-slate-200 bg-white shadow-sm italic text-slate-700 relative"
          >
    ...
    <section className="section-padding bg-slate-50 border-y border-slate-200 text-center">
      ...
      <p className="text-xl text-slate-600 mb-10 max-w-2xl mx-auto">
        Join hundreds of UK businesses that trust Sunburst House for their
        technology needs.
      </p>
      <button
        onClick={() => setPage("contact")}
    ...
    <header className="bg-slate-950 text-white py-24 px-6">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-xl text-slate-400 max-w-2xl mx-auto">
          Tailored IT solutions designed for the modern British enterprise. From
          managed support to bespoke development.
        </p>
      </div>
    </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div>
                <h4 className="font-bold text-slate-950 mb-3 flex items-center gap-2">
                  <Target size={18} className="text-brand-accent" /> Target
                  Audience
                </h4>
              ...
              <div>
                <h4 className="font-bold text-slate-950 mb-3 flex items-center gap-2">
                  <BarChart3 size={18} className="text-brand-accent" /> Key
                  Benefits
                </h4>
                ...
                {service.process.map((step, j) => (
                  <React.Fragment key={j}>
                    <div className="text-center">
                      <div className="w-8 h-8 bg-white border border-slate-200 rounded-full flex items-center justify-center text-xs font-bold mb-2">
                        {j + 1}
                      </div>
    ...
    <section className="section-padding grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      <div>
        ...
        <p className="text-lg text-slate-600 mb-6 leading-relaxed">
          Founded in the heart of London, Sunburst House began with a simple
          mission: to provide British businesses with the same level of IT
          sophistication usually reserved for global conglomerates.
        </p>
        <p className="text-lg text-slate-600 mb-8 leading-relaxed">
          Today, we are a leading managed service provider (MSP) known for our
          unwavering commitment to quality, security, and the success of our
          clients. We believe that technology should be an enabler, not a
          barrier.
        </p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
        <div>
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            reliable IT solutions that foster growth and resilience in a
            digital-first world.
          </p>
        </div>
        <div>
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            recognised for our technical excellence and human-centric approach
            to IT.
          </p>
        </div>
      </div>
    ...
    <section className="section-padding">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        {[
          ...
          {
            title: "Excellence",
            desc: "We strive for perfection in every ticket, project, and consultation.",
          },
          {
            title: "Innovation",
            desc: "We stay ahead of the curve to bring you the latest technology benefits.",
          },
          {
            title: "Security",
            desc: "Safety is at the core of everything we build and manage.",
          },
        ].map((v, i) => (
          <div
            key={i}
          ...
          >
            <h4 className="text-xl font-bold mb-3 text-brand-accent">
              {v.title}
            </h4>
    ...
    <section className="py-24 bg-brand-primary text-white text-center">
      <div className="max-w-7xl mx-auto ">
        ...
        <p className="max-w-3xl mx-auto text-slate-300 leading-relaxed">
          As a UK-based company, we are fully committed to the Data Protection
          Act 2018 and UK GDPR. We implement rigorous security measures, regular
          audits, and staff training to ensure your data—and your clients'
          data—is handled with the highest level of care and legality.
        </p>
      </div>
    </section>
  </div>
    ...
    <header className="bg-slate-50 py-24 px-6 border-b border-slate-200">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-xl text-slate-600 max-w-2xl mx-auto">
          Simple, predictable monthly plans with no hidden costs. All prices
          exclude VAT at 20%.
        </p>
      </div>
    </header>
      ...
      {PRICING_PLANS.map((plan, i) => (
        <div
          ...
          className={`relative p-8 rounded-3xl border ${
            plan.popular
              ? "border-brand-accent bg-white shadow-2xl scale-105 z-10"
    ...
    <section className="section-padding text-center">
      <div className="glass-panel p-12 rounded-3xl max-w-4xl mx-auto">
        ...
        <p className="text-slate-600 mb-8">
          ...
          requirements, we offer bespoke SLAs and dedicated infrastructure
          management.
        </p>
        <button
          onClick={() => setPage("contact")}
          ...
          {submitted ? (
            <div className="text-center py-12">
              ...
              <p className="text-slate-600">
                Thank you for contacting Sunburst House. One of our IT
                specialists will be in touch within 2 business hours.
              </p>
              <button
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    required
                    type="text"
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-brand-accent focus:ring-2 focus:ring-blue-100 outline-none transition-all"
              ...
              <div className="flex items-start gap-3">
                ...
                >
                  I consent to Sunburst House processing my personal data in
              ...
              <button
                type="submit"
                className="w-full bg-brand-primary text-white py-4 rounded-xl font-bold hover:bg-brand-accent transition-all shadow-lg shadow-blue-900/10"
              >
                Send Enquiry
              </button>
            </form>
          ...
          <>
            <div>
              ...
              <p>
                ...
                by Sunburst House ("the Company", "we", "us"). By engaging our
            ...
            <div>
              ...
              <p>
                All fees are quoted in Great British Pounds (GBP) and are
                subject to VAT at the prevailing rate (currently 20%). Invoices
                are payable within 14 days of issue unless otherwise agreed in
                writing.
              </p>
            </div>
            <div>
              ...
              <p>
                Unless otherwise stated, Sunburst House owns the intellectual
                property rights for all material and code generated during the
                provision of services, until full payment is received, at which
                point rights transfer to the client as per the specific service
                agreement.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                proprietary information shared during the course of business.
            ...
            <div>
              ...
              <p>
                To the maximum extent permitted by law, Sunburst House shall not
          ...
          <>
            <div>
              ...
              <p>
                ...
                company details when you contact us or use our services. We also
                collect technical data via cookies to improve our website
                experience.
              </p>
            </div>
            <div>
              ...
              <p>
                Data is processed to provide IT services, respond to enquiries,
                maintain security, and comply with legal obligations under UK
                GDPR.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>
                ...
                your personal data. You also have the right to object to or
                restrict processing. Contact us at {COMPANY_DETAILS.email} to
