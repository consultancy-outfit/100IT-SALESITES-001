...
import EleanorLiveWellLogo from "./assets/Eleanor_Live_Well.svg";
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <div
            className="w-[220px] h-[70px] overflow-hidden flex items-center cursor-pointer"
            onClick={() => setCurrentPage("home")}
          >
            <img
              src={EleanorLiveWellLogo}
              alt={`${COMPANY_DETAILS.name} logo`}
              className="w-60 h-25 object-cover object-center"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6">
              Empowering British businesses through strategic IT solutions and
        ...
        <div className="border-t border-slate-800 pt-8 mt-8 text-xs">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="mb-2">
                Registered Office Address (UK): {COMPANY_DETAILS.address}
              </p>
              <p>Company Registration Number (CRN): {COMPANY_DETAILS.crn}</p>
            </div>
            <div className="md:text-right">
              <p>
                © {new Date().getFullYear()} Eleanor Live Well Ltd. All rights
                reserved.
              </p>
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <span className="inline-block px-4 py-1.5 mb-6 text-sm font-semibold tracking-wide text-brand-accent uppercase bg-amber-50 rounded-full">
                Premium UK IT Services
              </span>
              <h1 className="text-5xl lg:text-6xl font-bold text-slate-900 leading-[1.1] mb-6">
                Strategic Technology for{" "}
                <span className="text-brand-accent">British Business</span>
              </h1>
              <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-lg">
                Eleanor Live Well provides enterprise-grade IT support, cloud
                strategy, and cyber security tailored for the UK market.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              Why Choose Eleanor Live Well?
            </h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
              We combine deep technical expertise with a human-centric approach
              to deliver IT services that actually drive growth.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Our entire team is based in the UK, ensuring no language barriers and local time zone alignment.",
                icon: <MapPin className="w-6 h-6" />,
              },
              {
                title: "GDPR Excellence",
                desc: "Security is at our core. We ensure every solution is fully compliant with UK data protection laws.",
                icon: <ShieldCheck className="w-6 h-6" />,
              },
              {
                title: "Predictable Pricing",
                desc: "No hidden fees. Our transparent GBP pricing helps you manage your budget with confidence.",
                icon: <CheckCircle2 className="w-6 h-6" />,
              },
            ].map((benefit, i) => (
              <div
                key={i}
                className="p-8 rounded-2xl border border-slate-100 hover:border-brand-accent transition-colors group"
              >
                <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mb-6 group-hover:bg-amber-50 group-hover:text-brand-accent transition-colors">
                  {benefit.icon}
                </div>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            ...
            <button
              onClick={() => setCurrentPage("about")}
              className="text-brand-accent font-semibold flex items-center mt-4 md:mt-0"
            >
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            <div className="lg:col-span-1">
              ...
              <p className="text-slate-600 mb-8">
                We pride ourselves on long-term partnerships with some of the
                UK's most innovative companies.
              </p>
              <div className="flex space-x-2">
                {[1, 2, 3, 4, 5].map((s) => (
                  <div key={s} className="w-5 h-5 text-yellow-400">
                    ★
                  </div>
                ))}
              </div>
              <p className="text-sm font-medium mt-2">
                Average 4.9/5 rating on Trustpilot
              </p>
            </div>
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-6">
              {TESTIMONIALS.map((t, i) => (
                <div key={i} className="p-8 bg-slate-50 rounded-2xl relative">
                  <div className="text-4xl text-slate-200 absolute top-4 right-6 font-serif">
                    "
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-brand-primary rounded-[40px] p-12 lg:p-20 text-center text-white relative overflow-hidden">
            ...
            <p className="text-xl text-slate-300 mb-12 max-w-2xl mx-auto relative z-10">
              Join dozens of UK businesses that trust Eleanor Live Well for
              their IT needs.
            </p>
            <button
              onClick={() => setCurrentPage("contact")}
              className="bg-white text-brand-primary px-10 py-4 rounded-xl font-bold text-lg hover:shadow-xl hover:-translate-y-1 transition-all relative z-10"
            >
              Get a Free IT Audit
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Comprehensive technology solutions designed to scale with your
            business.
          </p>
        </div>
          ...
          {SERVICES.map((service, i) => (
            ...
            >
              <div className="lg:w-1/2">
                <div className="w-16 h-16 bg-amber-50 text-brand-accent rounded-2xl flex items-center justify-center mb-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <div>
            ...
            <p className="text-lg text-slate-600 mb-6 leading-relaxed">
              Founded in the heart of the UK, Eleanor Live Well was born from a
              simple observation: many IT providers focus on the technology, but
              forget the people using it.
            </p>
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              We set out to build a different kind of IT company—one that speaks
              plain English, understands the unique challenges of the British
              business landscape, and prioritises long-term value over quick
              fixes.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-brand-accent p-8 rounded-2xl text-white shadow-xl max-w-xs">
              ...
              <p className="text-sm opacity-90">
                To provide world-class IT infrastructure that allows British
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-24">
          <div className="p-8 bg-white rounded-2xl border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-600">
              To be the most trusted technology partner for SMEs across the
              United Kingdom, known for integrity and excellence.
            </p>
          </div>
          <div className="p-8 bg-white rounded-2xl border border-slate-100 shadow-sm">
          ...
          <div className="p-8 bg-white rounded-2xl border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-600">
              We are fully committed to the UK GDPR. Every solution we design is
              "secure by design" and "private by default."
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Choose the plan that fits your business stage. All prices are in GBP
            and exclude VAT.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {PRICING_TIERS.map((tier, i) => (
            ...
            >
              ...
              <p
                className={`text-sm mb-8 ${tier.highlighted ? "text-slate-300" : "text-slate-500"}`}
              >
                {tier.idealFor}
              </p>
              <div className="mb-8">
                ...
                {tier.price !== "Custom" && (
                  <span
                    className={`text-sm ${tier.highlighted ? "text-slate-400" : "text-slate-500"}`}
                  >
                    /month
                  </span>
                )}
              ...
              <div className="mb-8 flex-grow">
                <h4
                  className={`text-xs font-bold uppercase tracking-widest mb-4 ${tier.highlighted ? "text-slate-400" : "text-slate-500"}`}
                >
                  What's Included
                </h4>
                <ul className="space-y-4">
                  {tier.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start text-sm">
                      <CheckCircle2
                        className={`w-4 h-4 mr-3 mt-0.5 ${tier.highlighted ? "text-brand-accent" : "text-emerald-500"}`}
                      />
                      {feature}
                    </li>
                  ))}
              ...
              <div
                className={`pt-8 border-t mb-8 ${tier.highlighted ? "border-white/10" : "border-slate-100"}`}
              >
        ...
        <div className="mt-16 text-center text-slate-500 text-sm">
          <p>
            * All plans are billed monthly. Custom enterprise plans available
            upon request.
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-lg text-slate-600 mb-12">
              Have a question or ready to start your IT transformation? Our
              UK-based team is ready to help.
            </p>

            <div className="space-y-8 mb-12">
              <div className="flex items-start">
                <div className="w-12 h-12 bg-amber-50 text-brand-accent rounded-xl flex items-center justify-center mr-6 flex-shrink-0">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      required
                      className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:ring-2 focus:ring-brand-accent focus:border-transparent outline-none transition-all"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-2">
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    required
                    className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:ring-2 focus:ring-brand-accent focus:border-transparent outline-none transition-all resize-none"
                  ></textarea>
                </div>
                <div className="flex items-start">
                  <input type="checkbox" required className="mt-1 mr-3" />
                  <p className="text-xs text-slate-500 leading-relaxed">
                    I consent to Eleanor Live Well storing my data to contact me
            ...
            content={
              <div className="space-y-8">
                <section>
                  ...
                  <p>
                    These terms and conditions govern your use of the Eleanor
                    Live Well website and the provision of our IT services. By
                ...
                <section>
                  ...
                  <p>
                    All prices quoted are in Great British Pounds (GBP) and are
                    subject to VAT at the prevailing UK rate. Payment for
                    managed services is due monthly in advance. Project-based
                    work requires a 50% deposit before commencement.
                  </p>
                </section>
                <section>
                  ...
                  <p>
                    Unless otherwise stated, Eleanor Live Well owns the
                    intellectual property rights for all material on this
                    website and all custom code developed during the provision
                    of services, until full payment has been received.
                  </p>
                </section>
                <section>
                  <h2 className="text-2xl font-bold mb-4">
                  ...
                  <p>
                    We acknowledge that in the course of providing IT services,
                    we may have access to confidential information. We commit to
                    maintaining strict confidentiality and will not disclose any
                    sensitive data to third parties without prior written
                    consent.
                  </p>
                </section>
                <section>
                  ...
                  <p>
                    To the maximum extent permitted by English law, Eleanor Live
                    Well shall not be liable for any indirect, incidental, or
              ...
              <div className="space-y-8">
                <section>
                  ...
                  <p>
                    ...
                    about us or our services. This includes names, email
                ...
                <section>
                  ...
                  <p>
                    ...
                    consent. This includes providing services and marketing
                    communications.
                  </p>
                </section>
                <section>
                  ...
                  <p>
                    ...
                    permitted by law (such as tax or accounting requirements).
                  </p>
                </section>
                <section>
                  <h2 className="text-2xl font-bold mb-4">
                  ...
                  <p>
                    ...
                    erase your personal data. You also have the right to object
                    to processing and the right to data portability. To exercise
                    these rights, please contact us at {COMPANY_DETAILS.email}.
                  </p>
                </section>
                <section>
                  ...
                  <p>
                    ...
                    or store information. You can set your browser to refuse all
                    or some browser cookies, or to alert you when websites set
                    or access cookies.
                  </p>
                </section>
                <section>
                  ...
                  <p>
                    ...
                    personal information we process. However, please remember
                    that no electronic transmission over the internet can be
