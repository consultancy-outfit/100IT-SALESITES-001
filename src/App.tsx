        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-sm leading-relaxed mb-6">
              ...
              security, and support. Your trusted partner in digital
              transformation.
            </p>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-zinc-600 mb-10 leading-relaxed max-w-xl">
                ...
                technical backbone your company needs to thrive in a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-3xl lg:text-4xl font-bold text-zinc-900 mb-6">
              Comprehensive IT Focus
            </h2>
            <p className="text-lg text-zinc-600">
              We specialize in delivering robust IT infrastructure that scales
              with your business. Our approach combines British engineering
              precision with modern cloud agility.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Aligning your technology roadmap with your commercial goals.",
                icon: Target,
              },
              {
                title: "Expert Support",
                desc: "UK-based helpdesk available round the clock for your peace of mind.",
                icon: Users,
              },
              {
                title: "Certified Security",
                desc: "Protecting your digital assets with Cyber Essentials frameworks.",
                icon: ShieldCheck,
              },
            ].map((item, i) => (
              <div
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-1/2 grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <img
                  src="https://picsum.photos/seed/ind1/400/500"
                  alt="Industry"
                  className="rounded-2xl w-full h-64 object-cover"
                  referrerPolicy="no-referrer"
                />
                <img
                  src="https://picsum.photos/seed/ind2/400/300"
                  alt="Industry"
              ...
              <div className="space-y-4 pt-8">
                <img
                  src="https://picsum.photos/seed/ind3/400/300"
                  alt="Industry"
                  className="rounded-2xl w-full h-48 object-cover"
                  referrerPolicy="no-referrer"
                />
                <img
                  src="https://picsum.photos/seed/ind4/400/500"
                  alt="Industry"
                  className="rounded-2xl w-full h-64 object-cover"
                  referrerPolicy="no-referrer"
                />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {CASE_STUDIES.map((study, i) => (
              <div
                key={i}
                className="bg-zinc-50 rounded-3xl p-8 lg:p-12 border border-zinc-100"
              >
          ...
          <div className="bg-zinc-900 rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-xl text-zinc-400 mb-12 max-w-2xl mx-auto">
                Join hundreds of UK businesses that trust us with their critical
                infrastructure. Let's discuss your goals today.
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-20 text-center">
          ...
          <p className="text-xl text-zinc-600 max-w-3xl mx-auto">
            Tailored IT solutions designed for the unique challenges of the
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.process.map((step, idx) => (
                        <span
                          key={idx}
                          className="px-3 py-1 bg-zinc-100 text-zinc-700 text-xs font-semibold rounded-full"
                        >
                          {idx + 1}. {step}
                        </span>
                      ))}
    ...
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          <div>
            <h1 className="text-4xl lg:text-6xl font-bold text-zinc-900 mb-8">
              Our Story
            </h1>
            <p className="text-xl text-zinc-600 mb-6 leading-relaxed">
              Founded in the heart of Barnsley, Barnsley Business Innovation Center began
              with a simple mission: to provide enterprise-grade technology
              solutions to the hardworking businesses of South Yorkshire and
              beyond.
            </p>
            <p className="text-lg text-zinc-600 mb-8 leading-relaxed">
              Over the last decade, we have grown from a small local helpdesk
              into a leading regional IT consultancy, known for our integrity,
              technical prowess, and commitment to British business success.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -left-8 bg-white p-8 rounded-2xl shadow-xl border border-zinc-100 max-w-xs">
              <p className="text-zinc-900 font-bold mb-2">
                "Technology is just a tool. Our people are the real solution."
              </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-32">
          <div className="bg-zinc-50 p-12 rounded-[2.5rem]">
            ...
            <p className="text-zinc-600 leading-relaxed">
              ...
              innovative IT infrastructure that drives efficiency and growth,
              backed by exceptional local support.
            </p>
          </div>
          <div className="bg-zinc-900 p-12 rounded-[2.5rem] text-white">
            ...
            <p className="text-zinc-400 leading-relaxed">
              ...
              recognised for our technical excellence and our contribution to
        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              {
                title: "Integrity",
                desc: "Honest advice, always in the client's best interest.",
              },
              {
                title: "Excellence",
                desc: "Striving for perfection in every cable run and server config.",
              },
              {
                title: "Innovation",
                desc: "Staying ahead of the curve to keep you competitive.",
              },
              {
                title: "Responsiveness",
                desc: "Because we know your business can't wait.",
              },
            ].map((value, i) => (
        ...
        <div className="bg-sky-50 p-12 lg:p-20 rounded-[3rem]">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-zinc-600 leading-relaxed">
              We take data protection seriously. As a UK-based firm, we are
              fully committed to GDPR compliance. We assist our clients in
              implementing robust data handling policies and security measures
    ...
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-zinc-600 max-w-3xl mx-auto">
            No hidden fees. Just professional IT support tailored to your
            business scale.
          </p>
          <p className="mt-4 text-sm font-bold text-zinc-500 uppercase tracking-widest">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {PRICING_PLANS.map((plan, i) => (
            ...
            >
              ...
              <p
                className={`text-sm mb-8 ${plan.isPopular ? "text-zinc-400" : "text-zinc-500"}`}
              >
                {plan.idealFor}
              </p>
              ...
              <div className="flex items-baseline mb-8">
                ...
                <span
                  className={`text-sm ml-2 ${plan.isPopular ? "text-zinc-400" : "text-zinc-500"}`}
                >
                  /user/month
                </span>
              </div>
        ...
        <div className="mt-24 bg-zinc-50 rounded-[3rem] p-12 text-center">
          ...
          <p className="text-zinc-600 mb-8 max-w-2xl mx-auto">
            For larger enterprises or specific project-based work (like network
            installations or cloud migrations), we provide bespoke quotes based
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-xl text-zinc-600 mb-12">
              Have a question or ready to start your project? Our UK-based team
              is here to help.
            </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <span className="text-xs text-zinc-500">
                    I consent to Barnsley Business Innovation Center processing my data in
                    accordance with their Privacy Policy. I understand my
                    information will be used to respond to this inquiry.
                  </span>
                </div>
                <button
                  type="submit"
            ...
            content={
              <>
                <section>
                  ...
                  <p>
                    Welcome to Barnsley Business Innovation Center. These terms and
                    conditions outline the rules and regulations for the use of
                    our website and services. By accessing this website, we
                ...
                <section>
                  ...
                  <p>
                    Unless otherwise stated, Barnsley Business Innovation Center and/or its
                    licensors own the intellectual property rights for all
                    material on this website. All intellectual property rights
                    are reserved.
                  </p>
                </section>
                <section>
                  ...
                  <p>
                    All services are billed in Great British Pounds (£).
                    Standard payment terms are 14 days from the date of invoice
                    unless otherwise agreed in writing. Late payments may incur
                    interest charges in accordance with UK law.
                  </p>
                </section>
                <section>
                  <h2 className="text-xl font-bold text-zinc-900 mb-4">
                  ...
                  <p>
                    We agree to keep all client data and business information
                    strictly confidential. This obligation extends to all
                    employees and contractors of Barnsley Business Innovation Center.
                  </p>
                </section>
                <section>
                  <h2 className="text-xl font-bold text-zinc-900 mb-4">
                  ...
                  <p>
                    Barnsley Business Innovation Center will not be liable for any indirect,
                    special, or consequential loss or damage arising under these
                    terms and conditions or in connection with our website or
                    services.
                  </p>
                </section>
                <section>
              ...
              <>
                <section>
                  ...
                  <p>
                    ...
                    when you fill out a contact form or request a quote. This
                    may include your name, email, company name, and phone
                    number.
                  </p>
                </section>
                <section>
                  ...
                  <p>
                    We use your data to respond to your inquiries, provide the
                    services you request, and send you important updates
                ...
                <section>
                  ...
                  <p>
                    ...
                    (GDPR), we ensure that your data is processed lawfully,
                    fairly, and transparently. You have the right to access,
                ...
                <section>
                  ...
                  <p>
                    ...
                    browser settings, although this may affect the functionality
                    of the site.
                  </p>
                </section>
                <section>
                  ...
                  <p>
                    ...
                    your data from unauthorized access, disclosure, or
                    destruction.
                  </p>
                </section>
              </>
