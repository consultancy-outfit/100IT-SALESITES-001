        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-slate-500 text-sm leading-relaxed mb-6">
              Leading the way in British IT excellence. We provide strategic
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-7xl font-bold text-slate-900 tracking-tight leading-[1.1] mb-8">
                Empowering UK Business Through{" "}
                <span className="text-slate-500 italic">
                  Strategic Technology.
                </span>
              </h1>
              <p className="text-xl text-slate-600 mb-10 leading-relaxed">
                The Bridgewater Complex provides enterprise-grade IT services,
                cyber security, and cloud consultancy tailored for the unique
                needs of the British market.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/services"
                  className="bg-slate-900 text-white px-8 py-4 rounded-full font-semibold flex items-center justify-center hover:bg-slate-800 transition-all shadow-lg shadow-slate-200"
                >
                  Explore Services <ArrowRight className="ml-2 w-5 h-5" />
                </Link>
                <Link
                  to="/contact"
                  className="bg-white border border-slate-200 text-slate-900 px-8 py-4 rounded-full font-semibold flex items-center justify-center hover:bg-slate-50 transition-all"
                >
                  Book a Consultation
                </Link>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100">
              ...
              <p className="text-slate-500 font-medium">
                Uptime Guarantee for Managed Clients
              </p>
            </div>
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100">
              <h3 className="text-4xl font-bold text-slate-900 mb-2">£2.4M+</h3>
              <p className="text-slate-500 font-medium">
                Saved for UK Clients in Efficiency Gains
              </p>
            </div>
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center max-w-2xl mx-auto">
            ...
            <p className="text-slate-400">
              We don't just fix computers; we build the technical foundation
            ...
            {[
              {
                ...
                desc: "UK-based support team that understands your business environment.",
                icon: <MapPin />,
              },
              {
                title: "Security First",
                desc: "GDPR compliance and robust cyber security are baked into every solution.",
                icon: <Lock />,
              },
              {
                title: "Scalable Growth",
                desc: "Technology that grows with you, from startup to enterprise.",
                icon: <ArrowRight />,
              },
              {
                title: "Fixed Costs",
                desc: "Transparent pricing with no hidden fees or surprise invoices.",
                icon: <Database />,
              },
            ].map((benefit, i) => (
              <div
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2">
              <span className="text-slate-500 font-semibold text-sm uppercase tracking-widest mb-4 block">
                Case Study
              </span>
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Digital Transformation for London Law Firm
              </h2>
              <p className="text-slate-600 mb-8 text-lg leading-relaxed">
                We migrated a 40-person legal practice to a secure cloud
                environment, implementing multi-factor authentication and
                automated backups.
              </p>
              ...
              <Link
                to="/services"
                className="text-slate-900 font-bold flex items-center hover:underline"
              >
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-16">
            Trusted by British Business Leaders
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                name: "Alistair Graham",
                role: "CEO, FinTech London",
                text: "Bridgewater transformed our infrastructure. Their response time is unmatched in the UK market.",
              },
              {
                name: "Sarah Jenkins",
                role: "Director, Manchester Logistics",
                text: "Professional, reliable, and they speak plain English. No technical jargon, just results.",
              },
              {
                name: "David Thorne",
                role: "Partner, Bristol Creative",
                text: "The peace of mind knowing our data is secure and GDPR compliant is worth every penny.",
              },
            ].map((t, i) => (
              <div
                key={i}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-slate-900 rounded-[40px] p-12 lg:p-20 text-white relative overflow-hidden">
            ...
            <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto relative z-10">
              Join dozens of UK businesses that trust The Bridgewater Complex
              for their technology needs.
            </p>
            <Link
              to="/contact"
              className="bg-white text-slate-900 px-10 py-5 rounded-full font-bold text-lg hover:bg-slate-100 transition-all relative z-10 inline-block"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-20">
          ...
          <p className="text-xl text-slate-600">
            Tailored technology solutions designed to solve real-world business
            challenges for UK enterprises.
          </p>
        </div>
              ...
              >
                <div className="lg:w-1/2">
                  ...
                  <div className="space-y-6">
                    <div>
                      <h4 className="font-bold text-slate-900 mb-2 uppercase text-xs tracking-widest">
                        Target Audience
                      </h4>
                ...
                <div className="lg:w-1/2 w-full bg-white p-8 lg:p-10 rounded-3xl border border-slate-200 shadow-sm">
                  ...
                  <div className="mt-12 pt-8 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <Link
                      to="/contact"
                      className="bg-slate-900 text-white px-6 py-3 rounded-full font-semibold hover:bg-slate-800 transition-all"
                    >
                      Enquire Now
                    </Link>
                  </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
          <div>
            ...
            <p className="text-xl text-slate-600 mb-6 leading-relaxed">
              Founded in the heart of the UK, The Bridgewater Complex was born
              from a simple observation: British businesses were being
              underserved by generic, one-size-fits-all IT providers.
            </p>
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              We set out to build a consultancy that combines enterprise-grade
              technical capability with the personal touch of a local partner.
              Today, we are proud to support some of the UK's most innovative
              companies, ensuring their technology is an asset, not a liability.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-32">
          {[
            {
              title: "Our Mission",
              text: "To provide UK businesses with the most secure, reliable, and strategic IT infrastructure possible.",
            },
            {
              title: "Our Vision",
              text: "To be the most trusted technology partner for British SMEs, driving innovation and growth.",
            },
            {
              title: "Our Values",
              text: "Integrity, technical excellence, and a relentless focus on client success guide everything we do.",
            },
          ].map((item, i) => (
            <div
              key={i}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                name: "Eleanor Vance",
                role: "CTO",
                img: "https://images.unsplash.com/photo-1594744803329-e58b31de8bf5?w=400&h=400&fit=crop",
              },
              {
                name: "Marcus Thorne",
              ...
              <div key={i} className="text-center">
                <img
                  src={p.img}
                  alt={p.name}
                  className="w-full aspect-square object-cover rounded-3xl mb-6 grayscale hover:grayscale-0 transition-all duration-500"
                  referrerPolicy="no-referrer"
                />
        ...
        <div className="bg-emerald-50 border border-emerald-100 p-12 rounded-[40px] flex flex-col md:flex-row items-center gap-10">
          ...
          <div>
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              fully compliant with the UK GDPR and the Data Protection Act 2018.
              We ensure that all client data is processed securely, stored
              within compliant jurisdictions, and handled with the highest level
              of confidentiality.
            </p>
          </div>
        </div>
    ...
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-xl text-slate-600">
            No hidden fees. No complex contracts. Just reliable IT support
        ...
        <div className="mt-20 p-10 rounded-[40px] bg-slate-50 border border-slate-100 text-center">
          ...
          <p className="text-slate-600 mb-8 max-w-2xl mx-auto">
            We understand that every business is unique. If our standard plans
            don't fit your requirements, we can create a bespoke package just
            for you.
          </p>
          <Link
            to="/contact"
            className="text-slate-900 font-bold flex items-center justify-center hover:underline"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            ...
            <p className="text-xl text-slate-600 mb-12">
              Have a question or ready to start your project? Fill out the form
              and our team will get back to you within 4 business hours.
            </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <label className="text-xs text-slate-500 leading-relaxed">
                    I consent to The Bridgewater Complex processing my data in
                    accordance with the{" "}
                    ...
                    <>
                      <section>
                        ...
                        <p>
                          ...
                          services provided by {COMPANY_DETAILS.name}. By
                          engaging our services, you agree to be bound by these
                          terms.
                        </p>
                      </section>
                      <section>
                        ...
                        <p>
                          All prices are quoted in Great British Pounds (£) and
                          are subject to VAT at the prevailing rate unless
                          otherwise stated. Invoices are payable within 14 days
                          of issue.
                        </p>
                      </section>
                      <section>
                        ...
                        <p>
                          ...
                          property rights in any work created by us during the
                          provision of services shall remain our property.
                        </p>
                      </section>
                      <section>
                        <h2 className="text-xl font-bold text-slate-900 mb-4">
                        ...
                        <p>
                          ...
                          information obtained from the other party that is
                          marked as confidential or which ought reasonably to be
                      ...
                      <section>
                        ...
                        <p>
                          Our total liability to you in respect of all losses
                          arising under or in connection with the services shall
                          be limited to the total fees paid by you for those
                  ...
                  content={
                    <>
                      <section>
                        ...
                        <p>
                          We collect personal data such as names, email
                          addresses, and phone numbers when you contact us or
                          use our services. We also collect technical data about
                      ...
                      <section>
                        ...
                        <p>
                          We process your data to provide our services, respond
                          to enquiries, improve our website, and comply with
                          legal obligations under the UK GDPR.
                        </p>
                      </section>
                      <section>
                        <h2 className="text-xl font-bold text-slate-900 mb-4">
                        ...
                        <p>
                          ...
                          collected, including for the purposes of satisfying
                      ...
                      <section>
                        ...
                        <p>
                          Under the UK GDPR, you have the right to access,
                          correct, or erase your personal data. You also have
                      ...
                      <section>
                        ...
                        <p>
                          ...
                          experience. You can manage your cookie preferences
                      ...
                      <section>
                        ...
                        <p>
                          ...
                          lost, used, or accessed in an unauthorised way.
                        </p>
                      </section>
                    </>
                  }
