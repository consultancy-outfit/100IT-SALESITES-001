...
const services = [
  {
    ...
    overview:
      "Full-lifecycle cloud management including migration, optimisation, and 24/7 support on Azure, AWS, and Google Cloud.",
    audience:
      "SMEs looking to scale infrastructure without heavy capital expenditure.",
  ...
  },
  {
    ...
    overview:
      "Advanced threat protection, vulnerability assessments, and Cyber Essentials certification readiness.",
    audience:
      "Businesses handling sensitive client data or requiring regulatory compliance.",
  ...
  },
  {
    ...
    overview:
      "Implementation and management of Microsoft 365, Teams, and SharePoint for seamless collaboration.",
    audience:
      "Distributed teams needing secure, integrated communication tools.",
  ...
  },
  {
    ...
    overview:
      "Design and installation of high-performance wired and wireless networks, including SD-WAN and VPNs.",
    audience:
      "Offices requiring robust, high-speed connectivity for critical operations.",
  ...
  },
  {
    ...
    overview:
      "Automated backup solutions and comprehensive business continuity planning to protect your data.",
    audience:
      "Any business where data loss would result in significant operational impact.",
  ...
  },
  {
    ...
    overview:
      "Unlimited remote and on-site support from our London-based team of expert engineers.",
  ...
  },
  {
    ...
    overview:
      "Bespoke web and mobile applications designed to solve specific business challenges.",
    audience:
      "Businesses needing unique digital tools to gain a competitive edge.",
...
export default function Services() {
  return (
    <div className="pt-24 pb-24">
      <section className="bg-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 mb-20 rounded-2xl shadow-sm border border-slate-100">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 mb-6">
            Comprehensive <span className="text-brand-accent">IT Services</span>{" "}
            for the Modern Enterprise.
          </h1>
          <p className="text-xl text-slate-600 leading-relaxed">
            We provide a full spectrum of technology solutions designed to
            enhance efficiency, security, and growth for UK businesses.
          </p>
        </div>
      </section>
                  ...
                  <div className="relative bg-white p-8 rounded-[2rem] shadow-xl border border-slate-100">
                    ...
                    <div className="mt-12 pt-8 border-t border-slate-100">
                      <p className="text-xs text-slate-400 italic">
                        * Prices are indicative and exclude VAT. Final pricing
                        depends on user count and specific infrastructure
                        requirements.
                      </p>
                    </div>
                  </div>
