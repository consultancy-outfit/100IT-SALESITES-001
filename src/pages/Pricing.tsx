    ...
    <div className="pt-32 pb-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {PLANS.map((plan, i) => (
            <motion.div
              ...
              className={`relative bg-white rounded-[2rem] p-8 shadow-sm border ${
                plan.highlight ? "border-brand-500 ring-4 ring-brand-50" : "border-slate-200"
              }`}
            >
              {plan.highlight && (
        ...
        <div className="mt-20 p-10 bg-white rounded-[2rem] border border-slate-200 flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <Link
            to="/contact"
            className="px-8 py-4 bg-white text-slate-900 border-2 border-slate-300 rounded-full font-bold hover:bg-slate-50 hover:border-brand-500 transition-all"
          >
