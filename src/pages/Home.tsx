...
const benefits = [
  {
    ...
    description:
      "Our entire support team is based in the UK, ensuring cultural alignment and local expertise.",
    icon: Headset,
  },
  {
    title: "Enterprise Security",
    description:
      "We implement military-grade cybersecurity protocols to protect your sensitive business data.",
    icon: ShieldCheck,
  },
  {
    title: "Scalable Solutions",
    description:
      "Our cloud-first approach allows your IT infrastructure to grow seamlessly with your business.",
    icon: Cloud,
  },
  {
    title: "Strategic Partnership",
    description:
      "We don't just fix computers; we align technology with your long-term business goals.",
    icon: TrendingUp,
  },
];
...
const caseStudies = [
  {
    ...
    description:
      "Migrated legacy on-premise servers to a secure private cloud, reducing maintenance costs by 40%.",
  },
  {
    company: "Midlands Manufacturing",
    result: "Zero Downtime in 24 Months",
    description:
      "Implemented a robust disaster recovery plan and 24/7 monitoring for a multi-site factory operation.",
  },
];
...
const testimonials = [
  {
    ...
    content:
      "Cornwall-Place transformed our chaotic IT setup into a streamlined, secure environment. Their response times are exceptional.",
  },
  {
    name: "Sarah Jenkins",
    ...
    content:
      "The peace of mind we have knowing our data is protected by their cybersecurity team is worth every penny. Highly recommended.",
  },
];
    ...
    <div className="flex flex-col">
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-white">
        <div className="absolute inset-0 z-0 opacity-30">
          <div className="absolute top-0 -left-4 w-72 h-72 bg-primary-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob"></div>
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl">
            ...
            >
              <span className="inline-block py-1 px-3 rounded-full bg-primary-500/10 text-primary-600 text-sm font-bold mb-6 border border-primary-500/30">
                UK's Leading IT Managed Services
              </span>
              <h1 className="text-5xl md:text-7xl text-slate-900 mb-8 leading-[1.1]">
                Future-Proof Your{" "}
                <span className="text-primary-500">British Business</span> with
                Smart IT.
              </h1>
              <p className="text-xl text-slate-600 mb-10 leading-relaxed">
                We provide comprehensive IT support, cybersecurity, and cloud
                consultancy tailored for the unique needs of UK enterprises.
                Reliable, secure, and always local.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  to="/services"
                  className="bg-slate-100 text-slate-800 border border-slate-200 px-8 py-4 rounded-full font-bold text-lg hover:bg-slate-200 transition-all text-center"
                >
                  Explore Services
                </Link>
              </div>
        ...
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl mb-6">
              Why Choose Cornwall-Place?
            </h2>
            <p className="text-lg text-slate-600">
              We combine deep technical expertise with a commitment to personal
              service, ensuring your technology works as hard as you do.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              <h2 className="text-3xl md:text-5xl mb-8">
                Specialised IT for UK Industries
              </h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Every sector has its own challenges. We've developed
                industry-specific IT frameworks that address compliance,
                security, and operational needs for Britain's key sectors.
              </p>
              ...
              {caseStudies.map((study, idx) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="text-primary-400 font-bold mb-2">
                      {study.company}
                    </div>
                    ...
                    <Link
                      to="/services"
                      className="text-sm font-bold flex items-center gap-2 hover:text-primary-400 transition-colors"
                    >
          ...
          <div className="bg-slate-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-xl text-slate-400 mb-12">
                Join hundreds of UK businesses that trust Cornwall-Place for
                their technology needs. Let's build something great together.
              </p>
