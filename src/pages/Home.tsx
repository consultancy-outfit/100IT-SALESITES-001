...
import { ChevronRight, Shield, Zap, Users, BarChart3, Globe, CheckCircle2, ArrowRight, Quote } from 'lucide-react';
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative pt-20 pb-32 lg:pt-32 lg:pb-48 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-white via-cyan-50/30 to-white -z-0" />
        <div className="absolute top-0 right-0 w-[60%] max-w-2xl h-[80%] bg-cyan-100/20 rounded-full blur-3xl -z-0" />
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-cyan-50/50 rounded-full blur-3xl -z-0" />
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              <span className="inline-block py-1.5 px-4 rounded-full bg-cyan-50 text-cyan-700 text-xs font-bold uppercase tracking-wider mb-6 border border-cyan-100/80">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold tracking-tight text-slate-900 mb-8 leading-[1.1]">
                Future-Proof Your <span className="text-cyan-600">Business Technology</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/contact"
                  className="bg-cyan-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-cyan-700 transition-all shadow-xl shadow-cyan-200 flex items-center justify-center gap-2 group"
                >
                  Book a Free Audit
                ...
                <Link
                  to="/services"
                  className="bg-white text-slate-900 border border-slate-200 px-8 py-4 rounded-xl font-bold text-lg hover:bg-slate-50 hover:border-cyan-200 transition-all flex items-center justify-center"
                >
                  Explore Services
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <Link to="/about" className="text-cyan-600 font-bold flex items-center gap-2 hover:gap-3 transition-all">
              ...
              <div key={idx} className="group cursor-pointer">
                <div className="relative overflow-hidden rounded-3xl mb-6">
                  <img
                    ...
                    referrerPolicy="no-referrer"
                  />
                  <div className="absolute top-6 left-6 bg-white/90 backdrop-blur px-4 py-2 rounded-full text-cyan-600 font-bold text-sm">
                    {study.result}
                  </div>
                </div>
                <h3 className="text-2xl font-bold text-slate-900 mb-2">{study.client}</h3>
                <p className="text-slate-600 mb-4">{study.description}</p>
                <span className="text-cyan-600 font-bold flex items-center gap-2 group-hover:gap-3 transition-all">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {TESTIMONIALS.map((t, idx) => (
              <div key={idx} className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100 relative">
                <Quote className="absolute top-8 right-8 text-cyan-100" size={60} />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="bg-cyan-600 rounded-[40px] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl shadow-cyan-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
              <Link
                to="/contact"
                className="bg-white text-cyan-600 px-10 py-4 rounded-xl font-bold text-lg hover:bg-slate-50 transition-all shadow-lg"
              >
                Get a Free Quote
              </Link>
              <Link
                to="/pricing"
                className="bg-cyan-700 text-white border border-cyan-500 px-10 py-4 rounded-xl font-bold text-lg hover:bg-cyan-800 transition-all"
              >
                View Pricing
              </Link>
            </div>
