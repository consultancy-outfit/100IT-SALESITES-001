    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center pt-20 bg-slate-900 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute -top-40 left-70 w-96 h-96 bg-white rounded-full blur-[120px]"></div>
        ...
        <div className="container-custom relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] tracking-tight">
              Future-Proof Your <span className="text-brand-500">Business</span>{" "}
              with Expert IT.
            </h1>
            <p className="text-lg md:text-xl text-slate-400 max-w-xl leading-relaxed">
              Island Business Centre delivers premium managed IT services,
              robust cybersecurity, and scalable cloud solutions tailored for
              the British market.
            </p>
            <div className="flex flex-wrap gap-4 pt-4">
              <Link
                to="/services"
                className="px-8 py-4 bg-brand-600 hover:bg-brand-700 text-white rounded-full font-bold transition-all flex items-center gap-2 shadow-xl shadow-brand-600/20"
              >
                Explore Services <ArrowRight size={20} />
              </Link>
              <Link
                to="/contact"
                className="px-8 py-4 bg-white/10 hover:bg-white/20 text-white border border-white/20 rounded-full font-bold transition-all"
              >
                Book a Consultation
              </Link>
            </div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 glass p-6 rounded-2xl shadow-2xl z-20 max-w-[200px]">
              ...
              <p className="text-xs text-slate-500 font-medium">
                Uptime Guarantee for all managed clients.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeIn}>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6 leading-tight">
                Your Local IT Department, <br />
                Only Smarter.
              </h3>
              <p className="text-slate-600 mb-8 leading-relaxed">
                Based in Telford, Island Business Centre has been at the
                forefront of the UK's IT evolution. We don't just fix computers;
                we build resilient digital foundations that allow businesses to
                scale without technical friction.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Average 15-minute response time for critical issues.",
                  },
                  {
                    icon: <ShieldCheck className="text-brand-500" />,
                    title: "UK Compliance",
                    desc: "Fully GDPR compliant and Cyber Essentials certified.",
                  },
                ].map((item, i) => (
            ...
            {[
              {
                ...
                desc: "No call centres. You get a direct line to our senior engineers who know your business inside out.",
              },
              {
                icon: <BarChart3 />,
                title: "Predictable Costs",
                desc: "Fixed-fee monthly plans help you manage your budget with zero hidden surprises.",
              },
              {
                icon: <Globe />,
                title: "Local Expertise",
                desc: "UK-based data centres and on-site support across the Midlands and beyond.",
              },
            ].map((benefit, i) => (
              <motion.div
                key={i}
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-slate-400">
                Real results delivered to our UK clients through strategic IT
                implementation.
              </p>
            </div>
            <Link
              to="/services"
              className="text-brand-400 font-bold flex items-center gap-2 hover:text-brand-300 transition-colors"
            >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              >
                ...
                <h4 className="text-2xl font-bold mb-2 text-brand-400">
                  {study.result}
                </h4>
            ...
            {[
              {
                ...
                role: "MD, Graham & Sons",
                text: "Island Business Centre transformed our remote working capabilities overnight. Their team is professional, knowledgeable, and always available.",
              },
              {
                name: "Sarah Jenkins",
                role: "Operations Director, Telford Tech",
                text: "The peace of mind we have knowing our cybersecurity is handled by IBC is invaluable. They are a true extension of our team.",
              },
              {
                name: "David Thompson",
                role: "Founder, Peak Performance",
                text: "Switching to their managed services was the best decision we made this year. Our IT costs are down and our productivity is up.",
              },
            ].map((t, i) => (
              <motion.div
                key={i}
      ...
      <section className="section-padding bg-brand-600 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center text-white">
          ...
          <p className="text-xl text-brand-100 mb-10 max-w-2xl mx-auto">
            Join hundreds of UK businesses that trust Island Business Centre for
            their IT needs.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              to="/contact"
              className="px-10 py-4 bg-white text-brand-600 rounded-full font-bold hover:bg-brand-50 transition-all shadow-xl"
            >
              Get Started Today
            </Link>
            <Link
              to="/pricing"
              className="px-10 py-4 bg-transparent border-2 border-white/30 text-white rounded-full font-bold hover:bg-white/10 transition-all"
            >
              View Pricing
            </Link>
          </div>
