  ...
  const benefits = [
    {
      ...
      description:
        "Advanced threat detection and 24/7 monitoring to keep your UK business safe from evolving cyber threats.",
      icon: Shield,
    },
    {
      title: "Strategic Growth",
      description:
        "IT roadmaps designed to scale with your organisation, ensuring technology is an asset, not a bottleneck.",
      icon: BarChart3,
    },
    {
      title: "Expert Support",
      description:
        "Direct access to UK-based senior engineers who understand your local business context and requirements.",
      icon: Users,
    },
  ];
  ...
  const caseStudies = [
    {
      ...
      description:
        "Optimised cloud infrastructure and automated supply chain tracking systems.",
    ...
    },
    {
      ...
      description:
        "Implemented secure data handling and encryption protocols for sensitive research data.",
    ...
    },
    {
      ...
      description:
        "Modernised legacy server systems with a high-availability hybrid cloud solution.",
      industry: "Retail",
    },
  ];
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-7xl font-display font-bold text-slate-900 leading-[1.1] mb-8">
                ...
                <span className="text-brand">British Innovation.</span>
              </h1>
              <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-xl">
                Wickham Hall provides bespoke IT services, cybersecurity, and
                managed solutions tailored for the unique challenges of the UK
                business landscape.
              </p>
            ...
            >
              <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl max-w-[520px] w-full mx-auto lg:mx-0 aspect-square">
                <img
                  src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=600&q=80"
                  alt="Modern UK Tech Office – Wickham Hall IT Consultancy"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-600">
              ...
              of the UK regulatory and commercial environment.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="mt-12">
                <Link
                  to="/about"
                  className="text-brand-light font-bold flex items-center hover:text-brand-light transition-colors"
                >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4 pt-12">
                <img
                  src="https://picsum.photos/seed/finance/400/500"
              ...
              <div className="space-y-4">
                ...
                />
                <img
                  src="https://picsum.photos/seed/manufacturing/400/500"
                  className="rounded-2xl shadow-lg"
                  alt="Manufacturing"
                  referrerPolicy="no-referrer"
                />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-slate-600">
                We don't just deliver technology; we deliver commercial value
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {caseStudies.map((study, idx) => (
              <div key={idx} className="group cursor-pointer">
                ...
                <div className="text-brand font-display font-bold text-xl mb-3">
                  {study.result}
                </div>
                <p className="text-slate-600 leading-relaxed">
                  {study.description}
          ...
          <div className="bg-brand rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden">
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-xl text-white/90 mb-12">
                Join hundreds of UK businesses that rely on Wickham Hall for
                their critical IT infrastructure and strategy.
              </p>
              <div className="flex flex-col sm:flex-row justify-center gap-6">
                <Link
                  to="/contact"
                  className="bg-white text-brand px-10 py-4 rounded-full font-bold text-lg hover:bg-brand/10 transition-all shadow-xl"
                >
                  Get Started Today
                </Link>
                <Link
                  to="/pricing"
                  className="bg-brand-dark text-white border border-brand px-10 py-4 rounded-full font-bold text-lg hover:bg-brand-darker transition-all"
                >
                  View Pricing
                </Link>
              </div>
