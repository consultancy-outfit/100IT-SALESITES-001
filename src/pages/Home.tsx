...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden bg-white pt-16 pb-24 lg:pt-32 lg:pb-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-kanmore-pink/10 text-kanmore-pink text-xs font-semibold uppercase tracking-wider mb-6">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-kanmore-pink opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-kanmore-pink"></span>
                </span>
                <span>Premier UK IT Partner</span>
              </div>
              <h1 className="text-5xl lg:text-7xl font-bold tracking-tight text-kanmore-dark leading-[1.1] mb-8">
                Intelligent IT Solutions for <span className="text-kanmore-pink">British Business.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <Link to="/contact" className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-kanmore-dark text-white font-semibold hover:bg-kanmore-pink transition-all group">
                  Book a Free Audit
                  <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link to="/services" className="inline-flex items-center justify-center px-8 py-4 rounded-full border border-zinc-200 text-kanmore-dark font-semibold hover:border-kanmore-pink hover:text-kanmore-pink transition-all">
                  Explore Services
                </Link>
              </div>
            </motion.div>
              ...
              <div className="aspect-square bg-zinc-50 rounded-3xl border border-zinc-100 p-8 relative overflow-hidden">
                ...
                <div className="relative z-10 grid grid-cols-2 gap-4 h-full">
                  <div className="space-y-4">
                    ...
                    <div className="h-1/2 bg-kanmore-dark rounded-2xl shadow-lg p-6 flex flex-col justify-between">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h3 className="text-4xl font-bold text-kanmore-dark mb-6 leading-tight">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-center space-x-3 text-zinc-700">
                    <CheckCircle2 className="h-5 w-5 text-kanmore-pink" />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl font-bold text-kanmore-dark">Sectors We Empower</h3>
          </div>
      ...
      {/* Case Studies */}
      <section className="py-24 bg-kanmore-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16">
            ...
            <Link to="/services" className="text-zinc-400 hover:text-kanmore-pink transition-colors mb-6 md:mb-0 flex items-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {CASE_STUDIES.map((study, i) => (
              <div key={i} className="bg-white/5 border border-white/10 p-10 rounded-3xl hover:bg-white/10 transition-all">
                <div className="text-kanmore-pink font-bold text-sm uppercase tracking-widest mb-4">{study.industry}</div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl font-bold text-kanmore-dark">What Our Clients Say</h3>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-kanmore-dark rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
              <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-kanmore-pink blur-[120px] rounded-full"></div>
              <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-kanmore-blue blur-[120px] rounded-full"></div>
            </div>
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                ...
                <Link to="/pricing" className="px-10 py-5 border border-white/30 text-white rounded-full font-bold hover:bg-kanmore-pink hover:border-kanmore-pink transition-all">
                  View Pricing
                </Link>
              </div>
            </div>
