          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-white leading-[1.1] mb-6">
                ...
                <span className="text-brand-accent">Modern Business.</span>
              </h1>
              <p className="text-xl text-slate-300 mb-10 leading-relaxed max-w-2xl">
                Servoca London provides enterprise-grade IT support, cloud
                strategy, and cyber security tailored for the UK market. We
                don't just fix problems; we drive growth.
              </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <p className="text-slate-600 mb-8 leading-relaxed">
                We understand that every sector has unique challenges. Our
                consultants have deep experience in delivering tailored IT
                strategies for:
              </p>
      ...
      <section className="py-24 bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600">
              How we've helped UK businesses thrive through technology.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              ...
              <div
                key={i}
                className="bg-slate-900 rounded-3xl p-10 text-white overflow-hidden relative group"
              >
            ...
            {[
              {
                ...
                text: "Servoca London transformed our IT from a bottleneck into a competitive advantage. Their response times are unmatched.",
              },
              {
                name: "Sarah Thompson",
                role: "Operations Director, NHS Trust Partner",
                text: "The peace of mind knowing our data is secure and GDPR compliant is invaluable. A truly professional team.",
              },
              {
                name: "David Wright",
                role: "Founder, Wright & Co Law",
                text: "Switching to Servoca was the best decision we made this year. Their cloud strategy has made remote work seamless for our staff.",
              },
            ].map((t, i) => (
              <div
                key={i}
      ...
      <section className="py-24  relative overflow-hidden">
        <div className="container-custom relative z-10 text-center">
          ...
          <p className="text-xl  mb-10 max-w-2xl mx-auto">
            Join hundreds of UK businesses that trust Servoca London for their
            IT needs. Let's build something great together.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/contact"
              className="bg-brand-accent text-white  px-8 py-4 rounded-lg font-bold text-lg transition-colors"
            >
              Get Started Now
            </Link>
            <Link
              to="/pricing"
              className="bg-brand-accent border-2 border-white text-white  px-8 py-4 rounded-lg font-bold text-lg transition-colors"
            >
              View Pricing Plans
            </Link>
          </div>
