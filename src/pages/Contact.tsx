        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-indigo-100 leading-relaxed">
              Have a question or ready to start your IT transformation? Our team
            ...
            <div className="lg:col-span-1 space-y-12">
              ...
              <div className="bg-slate-900 p-8 rounded-[2rem] text-white">
                ...
                <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                  Existing clients with 24/7 support contracts can access our
                  emergency helpdesk via the dedicated portal or their account
                  manager's direct line.
                </p>
                <a
                  href="#"
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <p className="text-slate-600 text-lg mb-8">
                      Thank you for contacting {COMPANY_DETAILS.name}. One of
                      our specialists will be in touch within 2 business hours.
                    </p>
                    <button
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-sm text-slate-500 leading-relaxed">
                          I consent to {COMPANY_DETAILS.name} storing my data to
                          process my enquiry in accordance with the{" "}
                          <a
                            href="/privacy"
