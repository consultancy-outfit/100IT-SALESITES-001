        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-stone-600 leading-relaxed">
              Have a question or ready to start your project? Our team of experts is here to help you navigate your technology journey.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div>
                ...
                <div className="space-y-8">
                  <div className="flex items-start space-x-6">
                    ...
                    <div>
                      <h4 className="text-sm font-bold uppercase tracking-widest text-stone-400 mb-1">Registered Office</h4>
                      <p className="text-lg text-stone-800 font-medium">{COMPANY_DETAILS.address}</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-6">
                    <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center text-emerald-600 shrink-0">
                    ...
                    <div>
                      <h4 className="text-sm font-bold uppercase tracking-widest text-stone-400 mb-1">Phone Number</h4>
                      <p className="text-lg text-stone-800 font-medium">{COMPANY_DETAILS.phone}</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-6">
                    <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center text-emerald-600 shrink-0">
                    ...
                    <div>
                      <h4 className="text-sm font-bold uppercase tracking-widest text-stone-400 mb-1">Official Email</h4>
                      <p className="text-lg text-stone-800 font-medium">{COMPANY_DETAILS.email}</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-6">
                    <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center text-emerald-600 shrink-0">
                    ...
                    <div>
                      <h4 className="text-sm font-bold uppercase tracking-widest text-stone-400 mb-1">Business Hours</h4>
                      <p className="text-lg text-stone-800 font-medium">{COMPANY_DETAILS.hours}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white p-10 lg:p-16 rounded-[3rem] shadow-xl border border-stone-100">
              <h2 className="text-3xl font-bold text-stone-900 mb-8">Send a Message</h2>
              {submitted ? (
                <motion.div
                ...
                >
                  ...
                  <p className="text-stone-600">Thank you for reaching out. One of our experts will be in touch within 24 hours.</p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    />
                    <label htmlFor="consent" className="text-sm text-stone-500 leading-relaxed">
                      I consent to Fradel Lodge processing my personal data in accordance with the <a href="/privacy" className="text-emerald-600 hover:underline">Privacy Policy</a>.
                    </label>
                  </div>
                  <button
                    type="submit"
