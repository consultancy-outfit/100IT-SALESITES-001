      ...
      <section className="relative py-24 bg-slate-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              Our Story: Technology <span className="text-brand">Built on Trust.</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center space-x-8">
            <div className="bg-brand-darker/80 px-6 py-3 rounded-lg border border-white/20">
              <span className="text-xs font-bold uppercase tracking-widest text-brand-light">Certified</span>
              <p className="font-bold">ISO 27001</p>
            </div>
            <div className="bg-brand-darker/80 px-6 py-3 rounded-lg border border-white/20">
              <span className="text-xs font-bold uppercase tracking-widest text-brand-light">Compliant</span>
