      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-24">
          ...
          <p className="text-xl text-slate-600 leading-relaxed">
            Founded in London, Vibrance Outreach was born from a simple
            observation: British businesses needed IT partners who combined
            technical excellence with genuine commercial understanding.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-32">
          <div className="bg-white border border-slate-200 text-slate-900 p-12 rounded-[3rem] relative overflow-hidden shadow-sm">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              To empower UK enterprises by providing secure, scalable, and
              strategic technology solutions that drive real business growth and
          ...
          <div className="bg-brand-600 text-white p-12 rounded-[3rem] relative overflow-hidden">
            ...
            <p className="text-lg text-brand-50 leading-relaxed">
              To be the most trusted technology partner for the British
              mid-market, known for our integrity, innovation, and unwavering
            ...
            {[
              {
                ...
                desc: "We provide honest advice, even when it's not the easiest path. Your trust is our most valuable asset.",
              },
              {
                icon: Award,
                title: "Excellence",
                desc: "We don't just fix problems; we engineer solutions that exceed industry standards and expectations.",
              },
              {
                icon: Heart,
                title: "Client Centric",
                desc: "Your business goals are our technology goals. We measure our success by your growth.",
              },
            ].map((value, i) => (
        ...
        <div className="bg-slate-50 p-12 rounded-[3rem] border border-slate-100 flex flex-col lg:flex-row gap-12 items-center mb-32">
          ...
          <div className="lg:w-2/3 space-y-6">
            <p className="text-lg text-slate-600">
              As a UK-based company, we are fully committed to the Data
              Protection Act 2018 and the UK GDPR. We treat your data with the
