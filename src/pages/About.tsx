...
const leadership = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1723990720522-e8e0d5f8c052?w=400&h=400&fit=crop',
  },
  {
    name: 'David Warner',
    ...
    image: 'https://images.unsplash.com/photo-1697319292673-f18acff2e959?w=400&h=400&fit=crop',
  },
  {
    name: 'Marcus Thorne',
    ...
    image: 'https://images.unsplash.com/photo-1581382575275-97901c2635b7?w=400&h=400&fit=crop',
  },
];
  ...
  return (
    <div className="pb-24">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-blue-600 p-8 rounded-2xl text-white shadow-xl">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {leadership.map((member) => (
            <div key={member.name} className="group">
              ...
              <p className="text-blue-600 font-semibold text-sm mb-4 uppercase tracking-wider">{member.role}</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-blue-50 rounded-3xl p-10 lg:p-16 border border-blue-100">
