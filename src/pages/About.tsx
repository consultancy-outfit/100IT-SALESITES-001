...
import { Target, Eye, Heart, ShieldCheck, Users, Briefcase, Award } from 'lucide-react';
    ...
    <div className="pb-24">
      ...
      <section className="relative py-24 bg-stone-900 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            >
              Founded in the heart of the North West, Greater Manchester IT Services was born from a simple observation: British SMEs deserve better technology partners.
            </motion.p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-stone-600 text-lg leading-relaxed">
              To empower UK businesses by providing innovative, secure, and reliable IT solutions that drive growth, efficiency, and competitive advantage in an ever-evolving digital landscape.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-stone-600 text-lg leading-relaxed">
              To be the most trusted and respected IT service provider in the UK, known for our technical excellence, unwavering integrity, and commitment to our clients' long-term success.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { icon: <ShieldCheck size={24} />, title: "Integrity", desc: "Honest advice, even if it means a smaller sale. We do what's right for you." },
            { icon: <Users size={24} />, title: "Collaboration", desc: "We act as an extension of your team, not just a third-party vendor." },
            { icon: <Award size={24} />, title: "Excellence", desc: "We strive for technical perfection in every deployment and support ticket." },
      ...
      <section className="bg-stone-50 py-24 border-y border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              { name: "David Thompson", role: "Founder & CEO", bio: "20+ years in enterprise IT architecture. Passionate about SME growth." },
              { name: "Sarah Miller", role: "Head of Operations", bio: "Expert in service delivery and client relationship management." },
              { name: "Mark Roberts", role: "Chief Security Officer", bio: "Certified Ethical Hacker with a focus on UK compliance standards." }
            ].map((leader, idx) => (
              <div key={idx} className="group">
                <div className="relative overflow-hidden rounded-3xl mb-6 aspect-[4/5]">
                  <img
                    src={`https://picsum.photos/seed/leader${idx}/400/500`}
                    alt={leader.name}
        ...
        <div className="bg-stone-900 rounded-[3rem] p-12 md:p-20 text-white flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-2/3 space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="bg-stone-800 px-6 py-3 rounded-full text-sm font-bold border border-stone-700">ICO Registered</div>
              <div className="bg-stone-800 px-6 py-3 rounded-full text-sm font-bold border border-stone-700">Cyber Essentials Plus</div>
              <div className="bg-stone-800 px-6 py-3 rounded-full text-sm font-bold border border-stone-700">ISO 27001 Aligned</div>
            </div>
          </div>
