          ...
          <div className="max-w-3xl">
            ...
            >
              <h1 className="text-4xl md:text-7xl mb-8">
                ...
                <span className="text-brand-600">British IT</span>.
              </h1>
              <p className="text-xl text-slate-600 leading-relaxed">
                Jackson Gardens was founded on a simple principle: that every
                British business deserves access to world-class technology and
                expert support, regardless of their size.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-brand-100 text-lg leading-relaxed">
                To be the UK's most trusted IT partner, known for our technical
                excellence, unwavering integrity, and commitment to the success
                of our clients.
              </p>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-1/2 order-1 lg:order-2 space-y-8">
              ...
              <h2 className="text-3xl md:text-5xl">
                From a Small London Office to a National IT Leader
              </h2>
              <p className="text-lg text-slate-600 leading-relaxed">
                Jackson Gardens began in 2010 with a team of three engineers in
                a small office in Shoreditch. We saw that many SMEs were being
                underserved by large, impersonal IT providers and overcharged
                for basic services.
              </p>
              <p className="text-lg text-slate-600 leading-relaxed">
                We decided to do things differently. By focusing on building
                real relationships and providing proactive, strategic advice, we
                quickly grew. Today, we support hundreds of businesses across
                the UK, from London to Edinburgh, but our core values remain
                exactly the same.
              </p>
              <div className="pt-4 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500">
                    98% client retention rate over the last decade.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              A team of dedicated professionals with decades of combined
              experience in the UK technology sector.
            </p>
          </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-slate-400 leading-relaxed">
              As a UK-based IT provider, we take data protection and GDPR
              compliance extremely seriously. We are registered with the
              Information Commissioner's Office (ICO) and implement
              industry-leading security protocols to ensure your data—and your
