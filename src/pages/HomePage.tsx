      ...
      <div className="max-w-3xl">
        ...
        >
          ...
          <h1 className="text-5xl lg:text-7xl font-bold text-white tracking-tight leading-[1.1] mb-8">
            Empowering British Business through{" "}
            <span className="text-indigo-400">Technical Excellence.</span>
          </h1>
          <p className="text-xl text-slate-400 leading-relaxed mb-10 max-w-2xl">
            From managed support to strategic digital transformation, we provide
            the infrastructure and expertise that drives growth for UK
            enterprises.
          </p>
  ...
  const benefits = [
    {
      ...
      desc: "Round-the-clock monitoring and helpdesk from our Cambridge-based team.",
      icon: Shield,
    },
    {
      title: "Strategic Roadmap",
      desc: "We don't just fix problems; we build long-term technology strategies.",
      icon: Zap,
    },
    {
      title: "GDPR Compliant",
      desc: "Full adherence to UK data protection laws and security standards.",
      icon: Globe,
    },
    {
      title: "Cost Efficiency",
      desc: "Predictable monthly billing with measurable ROI on all IT investments.",
      icon: BarChart3,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Why Isaac Newton House?
          </h2>
          <p className="text-slate-600 max-w-2xl mx-auto">
            We combine the precision of scientific inquiry with the pragmatism
            of modern business.
          </p>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        <div className="lg:w-1/2">
          ...
          <p className="text-slate-600 mb-8 leading-relaxed">
            Our expertise spans across diverse sectors, understanding the unique
            regulatory and operational challenges of the British market.
          </p>
        ...
        <div className="lg:w-1/2 grid grid-cols-2 gap-4">
          <div className="space-y-4">
            <div className="h-48 rounded-2xl bg-indigo-100 overflow-hidden">
              <img
                src="https://picsum.photos/seed/it1/600/400"
            ...
            <div className="h-64 rounded-2xl bg-slate-200 overflow-hidden">
              <img
                src="https://picsum.photos/seed/it2/600/400"
                className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-500"
                referrerPolicy="no-referrer"
              />
            </div>
          ...
          <div className="space-y-4 pt-8">
            <div className="h-64 rounded-2xl bg-slate-200 overflow-hidden">
              <img
                src="https://picsum.photos/seed/it3/600/400"
                className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-500"
                referrerPolicy="no-referrer"
              />
            </div>
            <div className="h-48 rounded-2xl bg-indigo-100 overflow-hidden">
              <img
                src="https://picsum.photos/seed/it4/600/400"
                className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-500"
                referrerPolicy="no-referrer"
              />
            </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {CASE_STUDIES.map((study, i) => (
          <div
            key={i}
            className="group relative overflow-hidden rounded-3xl bg-slate-900 p-8 lg:p-12 text-white"
          >
            <div className="relative z-10">
              <span className="text-indigo-400 font-mono text-sm mb-4 block">
                {study.client}
              </span>
  ...
  <section className="py-24 bg-indigo-600 relative overflow-hidden">
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
      ...
      <p className="text-xl text-indigo-100 mb-10">
        Join the ranks of forward-thinking British companies partnering with
        Isaac Newton House.
      </p>
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <Link
          to="/contact"
          className="bg-white text-indigo-600 px-10 py-4 rounded-full font-bold hover:bg-indigo-50 transition-all"
        >
          Book a Discovery Call
        </Link>
        <Link
          to="/pricing"
          className="bg-indigo-700 text-white px-10 py-4 rounded-full font-bold hover:bg-indigo-800 transition-all"
        >
          View Pricing
        </Link>
      </div>
