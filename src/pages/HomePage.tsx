...
const Hero = () => (
  <section className="relative overflow-hidden bg-slate-950 py-24 lg:py-32">
    <div className="absolute inset-0 overflow-hidden">
      <div className="absolute -top-[40%] -left-[10%] w-[70%] h-[70%] rounded-full bg-sky-500/10 blur-[120px]" />
      <div className="absolute -bottom-[40%] -right-[10%] w-[70%] h-[70%] rounded-full bg-pink-500/10 blur-[120px]" />
    </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="max-w-3xl">
        ...
        >
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-500/10 border border-sky-500/20 text-sky-300 text-xs font-semibold uppercase tracking-wider mb-6">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold text-white tracking-tight leading-[1.1] mb-8">
            Empowering British Business through <span className="text-sky-300">Technical Excellence.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              to="/contact"
              className="bg-sky-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-sky-500 transition-all flex items-center justify-center gap-2 group shadow-lg shadow-sky-500/30"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit, idx) => (
            <motion.div
              ...
              className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:border-sky-200 transition-colors group"
            >
      ...
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        ...
        <div className="lg:w-1/2 grid grid-cols-2 gap-4">
          <div className="space-y-4">
            <div className="h-48 rounded-2xl bg-sky-100 overflow-hidden">
  ...
  <section className="py-24 bg-white">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between mb-12">
        ...
        <Link to="/services" className="hidden sm:flex items-center gap-2 text-sky-600 font-semibold hover:gap-3 transition-all">
        ...
        {CASE_STUDIES.map((study, i) => (
          <div key={i} className="group relative overflow-hidden rounded-3xl bg-slate-900 p-8 lg:p-12 text-white">
            <div className="relative z-10">
              <span className="text-sky-300 font-mono text-sm mb-4 block">{study.client}</span>
              ...
              <div className="inline-flex items-center gap-4 px-6 py-3 bg-white/10 rounded-xl border border-white/10">
                ...
                <span className="text-xl font-bold text-sky-300">{study.result}</span>
              </div>
            </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {TESTIMONIALS.map((t, i) => (
          <div key={i} className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-between hover:-translate-y-1 hover:shadow-md transition-all">
            <p className="text-slate-600 italic mb-8 leading-relaxed">"{t.content}"</p>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center text-sky-600 font-bold">
                {t.name.charAt(0)}
              </div>
              <div>
...
const CTA = () => (
  <section className="py-24 bg-gradient-to-r from-sky-600 via-pink-500 to-amber-400 relative overflow-hidden">
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
      <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8">Ready to modernise your IT infrastructure?</h2>
      <p className="text-lg sm:text-xl text-sky-100 mb-10">Join the ranks of forward-thinking British companies partnering with {COMPANY_DETAILS.name}.</p>
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <Link to="/contact" className="bg-white text-sky-600 px-10 py-4 rounded-full font-bold hover:bg-sky-50 transition-all shadow-lg shadow-sky-500/30">
          Book a Discovery Call
        </Link>
        <Link to="/pricing" className="bg-slate-950/80 text-white px-10 py-4 rounded-full font-bold hover:bg-slate-950 transition-all">
          View Pricing
        </Link>
      </div>
    </div>
