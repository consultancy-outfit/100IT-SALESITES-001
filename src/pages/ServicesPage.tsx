        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-400">
              Specialized solutions designed for the unique demands of the UK
              business landscape.
            </p>
          </motion.div>
        </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {service.process.map((step, i) => (
                            <span
                              key={i}
                              className="px-3 py-1 bg-white border border-slate-200 rounded-full text-xs font-semibold text-slate-500"
                            >
                              {i + 1}. {step}
                            </span>
                          ))}
                  ...
                  <div className="lg:w-1/2 w-full">
                    <div className="bg-white rounded-3xl p-8 lg:p-12 border border-slate-200 shadow-sm sticky top-32">
                      ...
                      <p className="text-slate-600 mb-8">
                        Tailored pricing available based on your specific
                        infrastructure and user count.
                      </p>
                      <Link
                        to="/contact"
      ...
      <section className="py-24 bg-white border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-600 mb-10">
            Our consultants are ready to design a bespoke IT strategy that
            aligns with your business goals.
          </p>
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 bg-blue-600 text-white px-8 py-4 rounded-full font-bold hover:bg-blue-700 transition-all"
          >
