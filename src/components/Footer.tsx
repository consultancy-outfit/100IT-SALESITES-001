      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 bg-slate-900 rounded-lg hover:bg-red-600 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {NAV_LINKS.map((link) => (
                <li key={link.path}>
                  <Link to={link.path} className="text-sm hover:text-red-400 transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
              <li>
                <Link to="/terms" className="text-sm hover:text-red-400 transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="text-sm hover:text-red-400 transition-colors">
                  Privacy Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="/services" className="text-sm hover:text-red-400 transition-colors">Managed IT Support</Link></li>
              <li><Link to="/services" className="text-sm hover:text-red-400 transition-colors">Cybersecurity</Link></li>
              <li><Link to="/services" className="text-sm hover:text-red-400 transition-colors">Cloud Solutions</Link></li>
              <li><Link to="/services" className="text-sm hover:text-red-400 transition-colors">IT Consultancy</Link></li>
              <li><Link to="/services" className="text-sm hover:text-red-400 transition-colors">Infrastructure</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 text-sm">
              ...
              <a href={`tel:${COMPANY_DETAILS.phone}`} className="hover:text-red-400 transition-colors">
               0208 088 5472
              </a>
            </div>
            <div className="flex gap-3 text-sm">
              <Mail className="w-5 h-5 text-red-500 shrink-0" />
              <a href={`mailto:${COMPANY_DETAILS.email}`} className="hover:text-red-400 transition-colors">
        ...
        <div className="pt-10 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-slate-500">
          ...
          <div className="flex gap-6">
            ...
            <Link to="/contact" className="hover:text-red-400 transition-colors">Support</Link>
          </div>
        </div>
      </div>
    </footer>
