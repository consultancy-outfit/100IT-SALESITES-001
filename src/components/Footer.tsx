        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><Link to="/services" className="hover:text-blue-500 transition-colors">IT Services</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><Link to="/privacy" className="hover:text-blue-500 transition-colors">GDPR Compliance</Link></li>
              <li><Link to="/privacy" className="hover:text-blue-500 transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@blessdayhouse.co.uk" className="hover:text-blue-500">info@blessdayhouse.co.uk</a>
              </li>
